...
public abstract class AbstractBaseNestedOperation<T extends BaseTree> implements IBaseNestedService<T> {
     ...
     * @param id
     * @return
     * @see cn.mypandora.orm.service.IBaseNestedService#getDescendants(java.lang.Long)
     */
    //@formatter:on
    @Override
     ...
     * @param id
     * @return
     * @see cn.mypandora.orm.service.IBaseNestedService#getChilds(java.lang.Long)
     */
    //@formatter:on
    @Override
     ...
     * @param id
     * @return
     * @see cn.mypandora.orm.service.IBaseNestedService#getParent(java.lang.Long)
     */
    //@formatter:on
    @Override
     ...
     * @param id
     * @return
     * @see cn.mypandora.orm.service.IBaseNestedService#getAncestry(java.lang.Long)
     */
    //@formatter:on
    @Override
     ...
     * @param id
     * @param params
     * @see cn.mypandora.orm.service.IBaseNestedService#addChild(java.lang.Long, java.lang.Object)
     */
    //@formatter:on
    @Override
     ...
     * Description:
     * @param id
     * @see cn.mypandora.orm.service.IBaseNestedService#delChild(java.lang.Long)
     */
    //@formatter:on
    @Override
     ...
     * @param id
     * @param upId
     * @see cn.mypandora.orm.service.IBaseNestedService#moveUp(java.lang.Long, java.lang.Long)
     */
    //@formatter:on
    @Override
     ...
     * @param id
     * @param downId
     * @see cn.mypandora.orm.service.IBaseNestedService#moveDown(java.lang.Long, java.lang.Long)
     */
    //@formatter:on
    @Override
