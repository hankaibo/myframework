 ...
 * @Package: cn.littleprincess.orm.dao 
 ...
 *
 */
package cn.littleprincess.orm.dao.impl;
...
public abstract class BaseNestedDaoImpl<T extends BaseTree> extends BaseEntityDaoImpl<BaseTree> implements
     ...
     * @param id
     * @return
     * @see cn.littleprincess.orm.dao.IBaseNestedDao#getDescendants(java.lang.Long)
     */
    //@formatter:on
    @Override
     ...
     * @param id
     * @return
     * @see cn.littleprincess.orm.dao.IBaseNestedDao#getChilds(java.lang.Long)
     */
    //@formatter:on
    @Override
     ...
     * @param id
     * @return
     * @see cn.littleprincess.orm.dao.IBaseNestedDao#getParent(java.lang.Long)
     */
    //@formatter:on
    @Override
     ...
     * @param id
     * @return
     * @see cn.littleprincess.orm.dao.IBaseNestedDao#getAncestry(java.lang.Long)
     */
    //@formatter:on
    @Override
     ...
     * Description:
     * @param id
     * @see cn.littleprincess.orm.dao.IBaseNestedDao#lftPlus2(java.lang.Long)
     */
    //@formatter:on
    @Override
     ...
     * Description:
     * @param id
     * @see cn.littleprincess.orm.dao.IBaseNestedDao#rgtPlus2(java.lang.Long)
     */
    //@formatter:on
    @Override
     ...
     * Description:
     * @param params
     * @see cn.littleprincess.orm.dao.IBaseNestedDao#insertNode(java.lang.Object)
     */
    //@formatter:on
    @Override
     ...
     * Description:
     * @param id
     * @see cn.littleprincess.orm.dao.IBaseNestedDao#parentRgtPlus2(java.lang.Long)
     */
    //@formatter:on
    @Override
     ...
     * Description:
     * @param id
     * @see cn.littleprincess.orm.dao.IBaseNestedDao#lftMinus2(java.lang.Long)
     */
    //@formatter:on
    @Override
     ...
     * Description:
     * @param id
     * @see cn.littleprincess.orm.dao.IBaseNestedDao#rgtMinus2(java.lang.Long)
     */
    //@formatter:on
    @Override
     ...
     * Description:
     * @param id
     * @see cn.littleprincess.orm.dao.IBaseNestedDao#brotherPlus2(java.lang.Long)
     */
    //@formatter:on
    @Override
     ...
     * Description:
     * @param id
     * @see cn.littleprincess.orm.dao.IBaseNestedDao#brotherMinus2(java.lang.Long)
     */
    //@formatter:on
    @Override
     ...
     * @param id
     * @return
     * @see cn.littleprincess.orm.dao.IBaseNestedDao#isFirstNode(java.lang.Long)
     */
    //@formatter:on
    @Override
     ...
     * @param id
     * @return
     * @see cn.littleprincess.orm.dao.IBaseNestedDao#isLastNode(java.lang.Long)
     */
    //@formatter:on
    @Override
