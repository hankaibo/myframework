...
import cn.littleprincess.orm.MyBatisSql;
...
public abstract class BaseEntityDaoImpl<T extends BaseEntity> implements IBaseEntityDao<T> {
    ...
    private static final String FIND_BY_SQL = "cn.littleprincess.dao.base.dynaSql";
     ...
     * Description:添加实体。
     * @param t
     * @see cn.littleprincess.orm.IBaseEntityOperation#addEntity(cn.littleprincess.orm.BaseEntity )
     */
    // @formatter:on
    @Override
     ...
     * Description:更新实体。
     * @param t
     * @see cn.littleprincess.orm.IBaseEntityOperation#updateEntity(cn.littleprincess.orm. BaseEntity)
     */
    // @formatter:on
    @Override
     ...
     * @param id
     * @see cn.littleprincess.orm.IBaseEntityOperation#deleteEntity(java.io.Serializable
     * )
     */
    // @formatter:on
    @Override
     ...
     * @param ids
     * @see cn.littleprincess.orm.IBaseEntityOperation#bulkDelete(java.io.Serializable[])
     */
    // @formatter:on
    @Override
     ...
     * @param id
     * @return
     * @see cn.littleprincess.orm.IBaseEntityOperation#findById(java.io.Serializable)
     */
    // @formatter:on
    @Override
     ...
     * @return
     * @see cn.littleprincess.orm.IBaseEntityOperation#findAll()
     */
    // @formatter:on
    @Override
     ...
     * @param page
     * @return
     * @see cn.littleprincess.orm.IBaseEntityOperation#findByCondition(java.lang.String, java.lang.Object, cn.littleprincess.orm.Page)
     */
    // @formatter:on
    @Override
    ...
    private int countBySql(String sql) {
        ...
        return ((Number) sqlSession.selectOne("cn.littleprincess.dao.base.countSql", countSql)).intValue();
    }
