		...
		if (this.logarithmic && (0 >= this.getMin(0, this.data.length - 1) || 0 >= this.minimum)) this.fire("logarithmicAxisFailed", {
			...
			if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max) g = !0;
				...
				var k = this.labelFrequency,
					...
					u;
				!0 === h ? (u = Math.log(this.max) * Math.LOG10E - Math.log(this.minReal) * Math.LOG10E, this.stepWidth = this.axisWidth / u, 2 < u && (r = Math.ceil(Math.log(this.max) * Math.LOG10E) + 1, p = Math.round(Math.log(this.minReal) * Math.LOG10E), r > this.gridCountR && (n = Math.ceil(r / this.gridCountR)))) : this.stepWidth = this.axisWidth / (this.max - this.min);
				var q = 0;
				...
				for (d = p; d < r; d += n) if (p = q * d + this.min, p = AmCharts.roundTo(p, this.maxDecCount + 1), !this.integersOnly || Math.round(p) == p) if (isNaN(t) || Number(AmCharts.toFixed(p, t)) == p) {
					!0 === h && (0 === p && (p = this.minReal), 2 < u && (p = Math.pow(10, d)), w = -1 != String(p).indexOf("e") ? !0 : !1);
					this.useScientificNotation && (w = !0);
					this.usePrefixes && (w = !1);
					w ? (s = -1 == String(p).indexOf("e") ? p.toExponential(15) : String(p), c = s.split("e"), s = Number(c[0]), c = Number(c[1]), s = AmCharts.roundTo(s, 14), 10 == s && (s = 1, c += 1), s = s + "e" + c, 0 === p && (s = "0"), 1 == p && (s = "1")) : (h && (s = String(p).split("."), s[1] ? (v.precision = s[1].length, 0 > d && (v.precision = Math.abs(d))) : v.precision = -1), s = this.usePrefixes ? AmCharts.addPrefix(p, a.prefixesOfBigNumbers, a.prefixesOfSmallNumbers, v, !0) : AmCharts.formatNumber(p, v, v.precision));
...
AmCharts.RecItem = AmCharts.Class({
	construct: function(a, b, c, d, f, e, g, h, k, l) {
		...
		"V" == Ga && (B = 0);
		var x;
		I && (x = a.autoWrap && 0 === B ? AmCharts.wrappedText(r, c, p, m, n, W, h, f, 0) : AmCharts.text(r, c, p, m, n, W, h), Q = x.getBBox().width);
		if ("H" == Ga) {
			if (0 <= b && b <= V + 1 && (0 < s && 0 < v && b + k <= V + 1 && (Y = AmCharts.line(r, [b + k, b + k], [0, s], t, v, A), u.push(Y)), 0 < w && (W = AmCharts.line(r, [b, b + da, b + da], [N, N + X, X], C, w, A, y), u.push(W))), D = 0, G = b, g && 90 == B && (G -= n), !1 === d ? (W = "start", D = "bottom" == ea ? U ? D + s : D - s : U ? D - s : D + s, G += 3, f && (G += f / 2, W = "middle"), 0 < B && (W = "middle")) : W = "middle", 1 == Z && 0 < J && !g && !l && $ < V && (d = AmCharts.fitToBounds(b, 0, V), $ = AmCharts.fitToBounds($, 0, V), ha = d - $, 0 < ha && (fill = AmCharts.rect(r, ha, a.height, z, J), fill.translate(d - ha + da, X), u.push(fill))), "bottom" == ea ? (D += N + n / 2 + oa, U ? 0 < B ? (D = N - Q / 2 * Math.sin(aa) - s - 3, G += Q / 2 * Math.cos(aa)) : 0 > B ? (D -= s + n + 3 + 3 - Q / 2 * Math.sin(aa), G -= Q / 2 * Math.cos(aa)) : D -= s + n + 3 + 3 : 0 < B ? (D = N + Q / 2 * Math.sin(aa) + s + 3, G -= Q / 2 * Math.cos(aa)) : 0 > B ? (D = N + s + 3 - Q / 2 * Math.sin(aa) + 2, G += Q / 2 * Math.cos(aa)) : D += s + q + 3 + 3) : (D += X + n / 2 - oa, G += da, U ? 0 < B ? (D = Q / 2 * Math.sin(aa) + s + 3, G -= Q / 2 * Math.cos(aa)) : D += s + 3 : 0 < B ? (D = -(Q / 2) * Math.sin(aa) - s - 6, G += Q / 2 * Math.cos(aa)) : D -= s + n + 3 + q + 3), "bottom" == ea ? ha = (U ? N - s - 1 : N + q - 1) + oa : (ia = da, ha = (U ? X : X - s - q + 1) - oa), e && (G += e), X = G, 0 < B && (X += Q / 2 * Math.cos(aa)), x && (ea = 0, U && (ea = Q / 2 * Math.cos(aa)), X + ea > V + 2 || 0 > X)) x.remove(), x = null
		} else {
			0 <= b && b <= N + 1 && (0 < s && 0 < v && b + k <= N + 1 && (Y = AmCharts.line(r, [0, s], [b + k, b + k], t, v, A), u.push(Y)), 0 < w && (W = AmCharts.line(r, [0, da, V + da], [b, b + X, b + X], C, w, A, y), u.push(W)));
			W = "end";
			if (!0 === U && "left" == ea || !1 === U && "right" == ea) W = "start";
			D = b - n / 2;
			1 == Z && 0 < J && !g && !l && (d = AmCharts.fitToBounds(b, 0, N), $ = AmCharts.fitToBounds($, 0, N), aa = d - $, fill = AmCharts.polygon(r, [0, a.width, a.width, 0], [0, 0, aa, aa], z, J), fill.translate(da, d - aa + X), u.push(fill));
			D += n / 2;
			"right" == ea ? (G += da + V + oa, D += X, U ? (G -= s + 4, e || (D -= n / 2 + 3)) : (G += s + 4 + q, D -= 2)) : U ? (G += s + 4 - oa, e || (D -= n / 2 + 3), g && (G += da, D += X)) : (G += -s - q - 4 - 2 - oa, D -= 2);
			Y && ("right" == ea ? (ia += da + oa + V, ha += X, ia = U ? ia - q : ia + q) : (ia -= oa, U || (ia -= s + q)));
			e && (D += e);
			U = -3;
			"right" == ea && (U += X);
			x && (D > N + 1 || D < U) && (x.remove(), x = null)
		}
		Y && Y.translate(ia, ha);
...
AmCharts.AmGraph = AmCharts.Class({
	...
	createSerialGraph: function() {
		...
		var k = this.width,
			...
			q = [],
			t = [],
			v, s, w, A, C = this.chart.graphs.length,
		...
		var Q, x, Va, ab = l + 1,
			...
			La = this.negativeFillColors,
			Aa = this.negativeLineColor,
			Ma = this.fillAlphas,
			Na = this.negativeFillAlphas;
		"object" == typeof Ma && (Ma = Ma[0]);
		"object" == typeof Na && (Na = Na[0]);
		var Za = e.getCoordinate(e.min);
		e.logarithmic && (Za = e.getCoordinate(e.minReal));
		this.minCoord = Za;
		this.resetBullet && (this.bullet = "none");
		if (!da && ("line" == g || "smoothedLine" == g || "step" == g) && (1 == d.length && "step" != g && "none" == this.bullet && (this.bullet = "round", this.resetBullet = !0), La || void 0 != Aa)) {
			var Ha = ea;
			Ha > e.max && (Ha = e.max);
			Ha < e.min && (Ha = e.min);
			e.logarithmic && (Ha = e.minReal);
			var xa = e.getCoordinate(Ha),
				ub = e.getCoordinate(e.max);
			n ? (ab = l, bb = Math.abs(ub - xa), db = l, eb = Math.abs(Za - xa), Ya = cb = 0, e.reversed ? (Wa = 0, Xa = xa) : (Wa = xa, Xa = 0)) : (bb = k, ab = Math.abs(ub - xa), eb = k, db = Math.abs(Za - xa), Xa = Wa = 0, e.reversed ? (Ya = m, cb = xa) : Ya = xa + 1)
		}
		var ya = Math.round;
		this.pmx = ya(Wa);
		this.pmy = ya(cb);
		...
		if ("line" == g || "step" == g || "smoothedLine" == g) {
			if (0 < Z) {
				for (H = Z - 1; - 1 < H; H--) if (Q = d[H], x = Q.axes[e.id].graphs[b], Va = x.values.value, !isNaN(Va)) {
					Z = H;
					break
				}
				if (this.lineColorField) for (H = Z; - 1 < H; H--) if (Q = d[H], x = Q.axes[e.id].graphs[b], x.lineColor) {
					this.bulletColorSwitched = this.lineColorSwitched = x.lineColor;
					break
				}
				if (this.fillColorsField) for (H = Z; - 1 < H; H--) if (Q = d[H], x = Q.axes[e.id].graphs[b], x.fillColors) {
					this.fillColorsSwitched = x.fillColors;
					break
				}
				if (this.dashLengthField) for (H = Z; - 1 < H; H--) if (Q = d[H], x = Q.axes[e.id].graphs[b], !isNaN(x.dashLength)) {
					this.dashLengthSwitched = x.dashLength;
					break
				}
			}
			if (U < d.length - 1) for (H = U + 1; H < d.length; H++) if (Q = d[H], x = Q.axes[e.id].graphs[b], Va = x.values.value, !isNaN(Va)) {
				U = H;
				break
			}
		}
		...
		var R = [],
			S = [],
			Ba = !1;
		if ("line" == g || "step" == g || "smoothedLine" == g) if (this.stackable && "regular" == I || "100%" == I || this.fillToGraph) Ba = !0;
		...
		for (H = Z; H <= U; H++) {
			...
			if (ta) {
				T = this.stackable && "none" != I && "3d" != I ? ta.close : ta.value;
				if ("candlestick" == g || "ohlc" == g) T = ta.close, gb = ta.low, Ca = e.getCoordinate(gb), fb = ta.high, Da = e.getCoordinate(fb);
				la = ta.open;
				E = e.getCoordinate(T);
				isNaN(la) || (K = e.getCoordinate(la));
				...
				var ja = Q.x[X.id],
					Ia = this.periodSpan - 1,
					ka = Math.floor(D / 2) + Math.floor(Ia * D / 2),
					ua = ka,
					wb = 0;
				"left" == this.stepDirection && (wb = (2 * D + Ia * D) / 2, ja -= wb);
				"start" == this.pointPosition && (ja -= D / 2 + Math.floor(Ia * D / 2), ka = 0, ua = Math.floor(D) + Math.floor(Ia * D));
				"end" == this.pointPosition && (ja += D / 2 + Math.floor(Ia * D / 2), ka = Math.floor(D) + Math.floor(Ia * D), ua = 0);
				if (vb) {
				...
				ja > k + 1E5 && (ja = k + 1E5);
				n ? (F = E, M = K, K = E = ja, isNaN(la) && !this.fillToGraph && (M = Ga), Oa = Ca, Pa = Da) : (M = F = ja, isNaN(la) && !this.fillToGraph && (K = Ga));
				T < la && (x.isNegative = !0, La && (za = La), Na && (Qa = Na), void 0 != Aa && (ra = Aa));
				switch (g) {
				case "line":
					isNaN(T) ? u || (this.drawLineGraph(q, t, R, S), q = [], t = [], R = [], S = []) : (x.isNegative = T < ea ? !0 : !1, q.push(F), t.push(E), ca = F, ga = E, pa = F, qa = E, !Ba || isNaN(K) || isNaN(M) || (R.push(M), S.push(K)), void 0 == x.lineColor && void 0 == x.fillColors && isNaN(x.dashLength) || (this.drawLineGraph(q, t, R, S), q = [F], t = [E], R = [], S = [], !Ba || isNaN(K) || isNaN(M) || (R.push(M), S.push(K)), this.lineColorSwitched = x.lineColor, this.fillColorsSwitched = x.fillColors, this.dashLengthSwitched = x.dashLength));
					break;
				case "smoothedLine":
					isNaN(T) ? u || (this.drawSmoothedGraph(q, t, R, S), q = [], t = [], R = [], S = []) : (x.isNegative = T < ea ? !0 : !1, q.push(F), t.push(E), ca = F, ga = E, pa = F, qa = E, !Ba || isNaN(K) || isNaN(M) || (R.push(M), S.push(K)), void 0 == x.lineColor && void 0 == x.fillColors && isNaN(x.dashLength) || (this.drawSmoothedGraph(q, t, R, S), q = [F], t = [E], R = [], S = [], !Ba || isNaN(K) || isNaN(M) || (R.push(M), S.push(K)), this.lineColorSwitched = x.lineColor, this.fillColorsSwitched = x.fillColors, this.dashLengthSwitched = x.dashLength));
					break;
				case "step":
					if (!isNaN(T)) x.isNegative = T < ea ? !0 : !1, void 0 == x.lineColor && void 0 == x.fillColors && isNaN(x.dashLength) || (this.drawLineGraph(q, t, R, S), q = [], t = [], R = [], S = [], this.lineColorSwitched = x.lineColor, this.fillColorsSwitched = x.fillColors, this.dashLengthSwitched = x.dashLength), n ? (isNaN(v) || (q.push(v), t.push(E - ka)), t.push(E - ka), q.push(F), t.push(E + ua), q.push(F), !Ba || isNaN(K) || isNaN(M) || (R.push(w), S.push(K - ka), R.push(M), S.push(K - ka), R.push(M), S.push(K + ua))) : (isNaN(s) || (t.push(s), q.push(v), t.push(s), q.push(F - ka)), q.push(F - ka), t.push(E), q.push(F + ua), t.push(E), !Ba || isNaN(K) || isNaN(M) || (R.push(M - ka), S.push(A), R.push(M - ka), S.push(K), R.push(M + ua), S.push(K))), v = F, s = E, w = M, A = K, ca = F, ga = E, pa = F, qa = E, vb && (v = s = NaN, this.drawLineGraph(q, t, R, S), q = [], t = [], R = [], S = []);
					else if (!u) {
						if (1 >= this.periodSpan || 1 < this.periodSpan && F - v > ka + ua) v = s = NaN;
						this.drawLineGraph(q, t, R, S);
						q = [];
						t = [];
						R = [];
						S = []
				...
				case "column":
					...
					if (!isNaN(T)) {
						T < ea ? (x.isNegative = !0, La && (za = La), void 0 != Aa && (ma = Aa)) : x.isNegative = !1;
						var xb = e.min,
							yb = e.max;
						if (!(T < xb && la < xb || T > yb && la > yb)) if (n) {
							"3d" == I ? (P = E - 0.5 * (h + G) + G / 2 + J * $, O = M + z * $) : (P = Math.floor(E - (p / 2 - $) * (h + G) + G / 2), O = M);
							L = h;
							ca = F;
							ga = P + h / 2;
							pa = F;
							...
							ba = F - M;
							var Lb = O;
							O = AmCharts.fitToBounds(O, 0, k);
							ba += Lb - O;
							ba = AmCharts.fitToBounds(ba, -O, k - O + z * $);
							if (P < l && 0 < L && (na = new AmCharts.Cuboid(f, ba, L, z - a.d3x, J - a.d3y, za, Qa, N, ma, V, ha, r, n, Y, Ra), "bottom" != B && "inside" != B && "middle" != B)) if (B = e.reversed ? "left" : "right", 0 > T) B = e.reversed ? "right" : "left";
							else if ("regular" == I || "100%" == I) ca += this.dx
						} else {
							"3d" == I ? (O = F - 0.5 * (h + G) + G / 2 + z * $, P = K + J * $) : (O = F - (p / 2 - $) * (h + G) + G / 2, P = K);
							L = h;
							ca = O + h / 2;
							ga = E;
							pa = O + h / 2;
							...
							ba = E - K;
							var Mb = P;
							P = AmCharts.fitToBounds(P, this.dy, l);
							ba += Mb - P;
							ba = AmCharts.fitToBounds(ba, -P + J * $, l - P);
							if (O < k + $ * z && 0 < L) if (na = new AmCharts.Cuboid(f, L, ba, z - a.d3x, J - a.d3y, za, Qa, N, ma, this.lineAlpha, ha, r, n, Y, Ra), 0 > T && "middle" != B && "inside" != B) B = "bottom";
							else if (B = aa, "regular" == I || "100%" == I) ga += this.dy
						}
						if (na && (sa = na.set, sa.translate(O, P), this.columnsSet.push(sa), (x.url || this.showHandOnHover) && sa.setAttr("cursor", "pointer"), !da)) {
							...
							this.animateColumns(na, H, F, M, E, K);
				...
				case "candlestick":
					if (!isNaN(la) && !isNaN(T)) {
						...
						void 0 != x.lineColor && (ma = x.lineColor);
						if (n) {
							if (P = E - h / 2, O = M, L = h, P + L > l && (L = l - P), 0 > P && (L += P, P = 0), P < l && 0 < L) {
								var jb, kb;
								T > la ? (jb = [F, Pa], kb = [M, Oa]) : (jb = [M, Pa], kb = [F, Oa]);
								!isNaN(Pa) && !isNaN(Oa) && E < l && 0 < E && ($a = AmCharts.line(f, jb, [E, E], ma, V, N), ib = AmCharts.line(f, kb, [E, E], ma, V, N));
								ba = F - M;
								na = new AmCharts.Cuboid(f, ba, L, z, J, za, Ma, N, ma, V, ha, r, n, Y, Ra)
							}
						} else if (O = F - h / 2, P = K + N / 2, L = h, O + L > k && (L = k - O), 0 > O && (L += O, O = 0), ba = E - K, O < k && 0 < L) {
							var na = new AmCharts.Cuboid(f, L, ba, z, J, za, Qa, N, ma, V, ha, r, n, Y, Ra),
								lb, mb;
							T > la ? (lb = [E, Da], mb = [K, Ca]) : (lb = [K, Da], mb = [E, Ca]);
							!isNaN(Da) && !isNaN(Ca) && F < k && 0 < F && ($a = AmCharts.line(f, [F, F], lb, ma, V, N), ib = AmCharts.line(f, [F, F], mb, ma, V, N))
						}
						na && (sa = na.set, W.push(sa), sa.translate(O, P - N / 2), (x.url || this.showHandOnHover) && sa.setAttr("cursor", "pointer"), $a && (W.push($a), W.push(ib)), ca = F, ga = E, pa = F, qa = E, da || (x.x = n ? P + L / 2 : O + L / 2, this.animateColumns(na, H, F, M, E, K), this.addListeners(sa, x)))
					}
					break;
				case "ohlc":
					if (!(isNaN(la) || isNaN(fb) || isNaN(gb) || isNaN(T))) {
						T < la && (x.isNegative = !0, void 0 != Aa && (ra = Aa));
						var nb, ob, pb;
						if (n) {
							var qb = E - h / 2,
							...
							ob = AmCharts.line(f, [M, M], [qb, zb], ra, V, N, Y);
							0 < E && E < l && (nb = AmCharts.line(f, [Oa, Pa], [E, E], ra, V, N, Y));
							pb = AmCharts.line(f, [F, F], [zb, rb], ra, V, N, Y)
						} else {
							var sb = F - h / 2,
							...
							ob = AmCharts.line(f, [sb, Ab], [K, K], ra, V, N, Y);
							0 < F && F < k && (nb = AmCharts.line(f, [F, F], [Ca, Da], ra, V, N, Y));
							pb = AmCharts.line(f, [Ab, tb], [E, E], ra, V, N, Y)
						}
						W.push(ob);
						W.push(nb);
						W.push(pb);
				...
				if (!da && !isNaN(T)) {
					...
					if (this.end - this.start <= Bb || 0 === Bb) {
						var Ea = this.createBullet(x, pa, qa, H);
						Ea || (Ea = 0);
						...
						if (Cb) {
							...
							case "right":
								...
								break;
							case "bottom":
								n && "column" == g ? (ca = Ga, 0 > T || 0 < T && e.reversed ? (va = -6, fa.attr({
									"text-anchor": "end"
								})) : (va = 6, fa.attr({
									"text-anchor": "start"
								}))) : (wa = Ea / 2 + Fa / 2, fa.x = -(Ja / 2 + 2));
								break;
							case "middle":
								"column" == g && (n ? (wa = -(Fa / 2) + this.fontSize / 2, va = -(F - M) / 2 - z, 0 > ba && (va += z), Math.abs(F - M) < Ja && !this.showAllValueLabels && (fa.remove(), fa = null)) : (wa = -(E - K) / 2, 0 > ba && (wa -= J), Math.abs(E - K) < Fa && !this.showAllValueLabels && (fa.remove(), fa = null)));
								break;
							case "inside":
								n ? (wa = -(Fa / 2) + this.fontSize / 2, va = 0 > ba ? Ja / 2 + 6 : -Ja / 2 - 6) : wa = 0 > ba ? Fa : -Fa
							}
							if (fa) {
						...
						if ("regular" == I || "100%" == I) {
							var Fb = e.totalText;
							if (Fb) {
								var Ka = this.createLabel(x, 0, 0, Fb, e.totalTextColor);
								this.allBullets.push(Ka);
								var Gb = Ka.getBBox(),
									Hb = Gb.width,
									Ib = Gb.height,
									Sa, Ta, Jb = e.totals[H];
								...
								var Ua = 0;
								"column" != g && (Ua = Ea);
								n ? (Ta = E, Sa = 0 > T ? F - Hb / 2 - 2 - Ua : F + Hb / 2 + 3 + Ua) : (Sa = F, Ta = 0 > T ? E + Ib / 2 + Ua : E - Ib / 2 - 3 - Ua);
								Ka.translate(Sa, Ta);
								e.totals[H] = Ka;
								n ? (0 > Ta || Ta > l) && Ka.remove() : (0 > Sa || Sa > k) && Ka.remove()
							}
						}
					}
				}
		...
		if ("line" == g || "step" == g || "smoothedLine" == g)"smoothedLine" == g ? this.drawSmoothedGraph(q, t, R, S) : this.drawLineGraph(q, t, R, S), da || this.launchAnimation();
	...
	drawLineGraph: function(a, b, c, d) {
		...
		if (1 < a.length) {
			...
			r && (n = r);
			var r = f.fillColorsR,
				u = f.fillColorsSwitched;
			u && (r = u);
			var q = f.dashLength;
			(u = f.dashLengthSwitched) && (q = u);
			var u = f.negativeLineColor,
				t = f.negativeFillColors,
	...
	drawSmoothedGraph: function(a, b, c, d) {
		if (1 < a.length) {
			...
			0 < m && (k = a.join(";").split(";"), n = b.join(";").split(";"), l = "", 0 < c.length ? (c.push("M"), d.push("M"), c.reverse(), d.reverse(), k = a.concat(c), n = b.concat(d)) : (this.rotate ? (l += " L" + t + "," + b[b.length - 1], l += " L" + t + "," + b[0]) : (l += " L" + a[a.length - 1] + "," + t, l += " L" + a[0] + "," + t), l += " L" + a[0] + "," + b[0]), c = new AmCharts.Bezier(e, k, n, NaN, 0, 0, p, m, f, l), c.path.pattern(this.pattern), g.push(c.path), u || void 0 !== r) && (q || (q = m), u || (u = r), a = new AmCharts.Bezier(e, a, b, NaN, 0, 0, u, q, f, l), a.path.pattern(this.pattern), h.push(a.path));
			this.applyMask(h, g)
		}
	},
	...
	createBullet: function(a, b, c, d) {
		...
		var u = a.alpha;
		isNaN(u) || (r = u);
		if ("none" != this.bullet || a.bullet) k = AmCharts.bullet(d, f, e, l, r, g, n, p, h, 0, m);
		...
		k && ((a.url || this.showHandOnHover) && k.setAttr("cursor", "pointer"), "serial" == this.chart.type && (0 > b - 0 || b - 0 > this.width || c < -e / 2 || c - 0 > this.height) && (k.remove(), k = null), k && (this.bulletSet.push(k), k.translate(b, c), this.addListeners(k, a), this.allBullets.push(k)), a.bx = b, a.by = c);
		a.bulletGraphics = k;
		return e
	},
...
AmCharts.ChartCursor = AmCharts.Class({
	...
	createCursor: function() {
		...
		this.set.push(b);
		a ? (f && (g.pointerWidth = 0), "right" == d ? f ? g.setBounds(n, p + m, n + r + l, p + u + m) : g.setBounds(n + r + l + e, p + m, n + r + 1E3, p + u + m) : f ? g.setBounds(n, p, r + n, u + p) : g.setBounds(-1E3, -1E3, n - q - e, p + u + 15)) : (g.maxWidth = r, c.parseDates && (q = 0, g.pointerWidth = 0), "top" == d ? f ? g.setBounds(n + l, p + m, r + l + n, u + p) : g.setBounds(n + l, -1E3, r + l + n, p + m - q - e) : f ? g.setBounds(n, p, r + n, u + p - q) : g.setBounds(n, p + u + q + e - 1, n + r, p + u + q + e));
		this.hideCursor()
	},
			...
			if (p) {
				...
				if (c.mouseIsOver || y || z || this.forceShow) if (this.forceShow = !1, z) {
					...
					0 !== d && (g = {
						type: "zoomed",
						target: this
					}, g.chart = this.chart, e.parseDates && !e.equalSpacing ? (c + d > w && (d = w - c), y + d < s && (d = s - y), g.start = y + d, g.end = c + d, this.fire(g.type, g)) : B + d >= this.data.length || 0 > k + d || (g.start = k + d, g.end = B + d, this.fire(g.type, g)))
				} else {
					"start" == A && (r -= e.cellWidth / 2);
					...
					t = !0;
					y && (t = !1);
					this.categoryBalloonEnabled && t ? (u ? (q && ("right" == C ? v.setBounds(k, l + h, k + m + g, l + r + h) : v.setBounds(k, l + h, k + m + g, l + r)), "right" == C ? q ? v.setPosition(k + m + g, l + r + h) : v.setPosition(k + m + g + I, l + r + h) : q ? v.setPosition(k, l + r) : v.setPosition(k - I, l + r)) : "top" == C ? q ? v.setPosition(k + r + g, l + h) : v.setPosition(k + r + g, l + h - I + 1) : q ? v.setPosition(k + r, l + n) : v.setPosition(k + r, l + n + I - 1), (s = this.categoryBalloonFunction) ? v.showBalloon(s(p.category)) : e.parseDates ? (e = AmCharts.formatDate(p.category, this.categoryBalloonDateFormat), -1 != e.indexOf("fff") && (e = AmCharts.formatMilliseconds(e, p.category)), v.showBalloon(e)) : v.showBalloon(AmCharts.fixNewLines(p.category))) : v.hide();
					J && this.bulletsEnabled && this.showBullets();
					if (this.oneBalloonOnly) {
						h = Infinity;
						for (w = 0; w < J.length; w++) e = J[w], e.showBalloon && !e.hidden && e.balloonText && (v = p.axes[e.valueAxis.id].graphs[e.id], s = v.y, isNaN(s) || (u ? Math.abs(d - s) < h && (h = Math.abs(d - s), B = e) : Math.abs(f - s) < h && (h = Math.abs(f - s), B = e)));
					...
					if (a != this.previousIndex || B != this.previousMostCloseGraph) if (this.normalizeBulletSize(), this.destroyValueBalloons(), this.resizedBullets = [], J && this.valueBalloonsEnabled && t && c.balloon.enabled) {
						...
						for (w = 0; w < J.length; w++) if (e = J[w], (!this.oneBalloonOnly || e == B) && e.showBalloon && !e.hidden && e.balloonText && ("step" == e.type && "left" == e.stepDirection && (p = this.data[a + 1]), p)) {
							v = p.axes[e.valueAxis.id].graphs[e.id];
							s = v.y;
							if (this.showNextAvailable && isNaN(s) && a + 1 < this.data.length) for (r = a + 1; r < this.data.length; r++) if (q = this.data[r]) if (v = q.axes[e.valueAxis.id].graphs[e.id], s = v.y, !isNaN(s)) break;
							if (!isNaN(s)) {
								q = v.x;
								t = !0;
								if (u) {
								...
								t && (1 != this.graphBulletSize && AmCharts.isModern && (t = v.bulletGraphics) && (t.getBBox(), t.translate(v.bx, v.by, this.graphBulletSize), this.resizedBullets.push(v)), t = e.valueBalloon, C = c.getBalloonColor(e, v), t.setBounds(k, l, k + m, l + n), t.pointerOrientation = "H", t.changeColor(C), void 0 !== e.balloonAlpha && (t.fillAlpha = e.balloonAlpha), void 0 !== e.balloonTextColor && (t.color = e.balloonTextColor), t.setPosition(r + k, q + l), r = c.formatString(e.balloonText, v, !0), (q = e.balloonFunction) && (r = q(v, e).toString()), "" !== r && (u ? t.showBalloon(r) : (t.text = r, t.show = !0)), !u && t.set && t.set.hide(), h.push({
									yy: s,
									balloon: t
								}))
							}
					...
					b ? (g = {
						type: "changed"
					}, g.index = a, g.chart = this.chart, g.zooming = y, g.mostCloseGraph = B, g.position = u ? f : d, g.target = this, c.fire("changed", g), this.fire("changed", g), this.skipZoomDispatch = !1) : (this.skipZoomDispatch = !0, c.updateLegendValues(a));
		...
		if (!isNaN(a)) {
			...
			if (this.show) {
				...
				var h = z + q,
					...
					B = this.bulletSize,
					Z;
				0 < s || 0 === t ? (0 < q && (a = AmCharts.rect(f, y, w, n, 0, u + 1, I, q, this.cornerRadius), AmCharts.isModern ? a.translate(1, 1) : a.translate(4, 4), e.push(a)), n = AmCharts.rect(f, y, w, n, this.fillAlpha, u, p, this.borderAlpha, this.cornerRadius), this.showBullet && (Z = AmCharts.circle(f, B, r, this.fillAlpha), e.push(Z))) : (r = [], s = [], "H" != v ? (g = a - A, g > y - t && (g = y - t), g < t && (g = t), r = [0, g - t, a - A, g + t, y, y, 0, 0], s = J ? [0, 0, b - z, 0, 0, w, w, 0] : [w, w, b - z, w, w, 0, 0, w]) : (r = b - z, r > w - t && (r = w - t), r < t && (r = t), s = [0, r - t, b - z, r + t, w, w, 0, 0], r = a < g + (k - g) / 2 ? [0, 0, A < a ? 0 : a - A, 0, 0, y, y, 0] : [y, y, A + y > a ? y : a - A, y, y, 0, 0, y]), 0 < q && (a = AmCharts.polygon(f, r, s, n, 0, u, I, q), a.translate(1, 1), e.push(a)), n = AmCharts.polygon(f, r, s, n, this.fillAlpha, u, p, this.borderAlpha));
				this.bg = n;
				e.push(n);
				n.toFront();
				f = 1 * this.deltaSignX;
...
AmCharts.handDrawnLine = function(a, b, c, d, f, e, g, h, k, l, m) {
	var n = a.set();
	for (m = 1; m < b.length; m++) for (var p = [b[m - 1], b[m]], r = [c[m - 1], c[m]], r = AmCharts.makeHD(p, r, a.handDrawScatter), p = r[0], r = r[1], u = 1; u < p.length; u++) n.push(AmCharts.line(a, [p[u - 1], p[u]], [r[u - 1], r[u]], d, f, e + Math.random() * a.handDrawThickness - a.handDrawThickness / 2, g, h, k, l, !0));
	return n
};
...
AmCharts.wedge = function(a, b, c, d, f, e, g, h, k, l, m, n) {
	...
	var t = 1 / 180 * Math.PI,
		...
		s = b + Math.sin(d * t) * e,
		w = c - Math.cos(d * t) * g,
		A = b + Math.sin((d + f) * t) * e,
		C = c - Math.cos((d + f) * t) * g,
		y = b + Math.sin((d + f) * t) * h,
		t = c - Math.cos((d + f) * t) * r,
		z = {
	...
	0 < k && (u ? (B = " M" + q + "," + (v + k) + " L" + s + "," + (w + k), I || (B += " A" + (b - e) + "," + (k + c - g) + "," + (b + e) + "," + (k + c + g) + "," + s + "," + (w + k) + "," + A + "," + (C + k)), B += " L" + y + "," + (t + k), 0 < h && (I || (B += " B" + (b - h) + "," + (k + c - r) + "," + (b + h) + "," + (k + c + r) + "," + y + "," + (k + t) + "," + q + "," + (k + v)))) : (B = " M" + q + "," + (v + k) + " L" + s + "," + (w + k) + (" A" + e + "," + g + ",0," + J + ",1," + A + "," + (C + k) + " L" + y + "," + (t + k)), 0 < h && (B += " A" + h + "," + r + ",0," + J + ",0," + q + "," + (v + k))), B += " Z", B = a.path(B, void 0, void 0, "1000,1000").attr(z), d.push(B), B = a.path(" M" + q + "," + v + " L" + q + "," + (v + k) + " L" + s + "," + (w + k) + " L" + s + "," + w + " L" + q + "," + v + " Z", void 0, void 0, "1000,1000").attr(z), k = a.path(" M" + A + "," + C + " L" + A + "," + (C + k) + " L" + y + "," + (t + k) + " L" + y + "," + t + " L" + A + "," + C + " Z", void 0, void 0, "1000,1000").attr(z), d.push(B), d.push(k));
	...
	createEntry: function(a) {
		if (!1 !== a.visibleInLegend) {
			...
			var k = this.container,
				...
				n = 0,
				p = l / 2;
			if (this.useGraphSettings) if (m = a.type, this.switchType = void 0, "line" == m || "step" == m || "smoothedLine" == m || "ohlc" == m) g = k.set(), a.hidden || (d = a.lineColorR, e = a.bulletBorderColorR), n = AmCharts.line(k, [0, 2 * l], [l / 2, l / 2], d, a.lineAlpha, a.lineThickness, a.dashLength), g.push(n), a.bullet && (a.hidden || (d = a.bulletColorR), n = AmCharts.bullet(k, a.bullet, a.bulletSize, d, a.bulletAlpha, a.bulletBorderThickness, e, a.bulletBorderAlpha)) && (n.translate(l + 1, l / 2), g.push(n)), p = 0, m = l, n = l / 3;
			else {
				var r;
