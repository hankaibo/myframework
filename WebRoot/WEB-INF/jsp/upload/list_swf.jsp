    ...
    $(function(){
        $('.pagination').jqPagination({
            ...
            paged       : function(pageNum) {
                ...
                location.href="<%= appContextPath %>/upload/listswf.html?currentPage="+pageNum;
            }
        }); 
    });
</script>
...
<div class="container" style="margin: 0;width:100%">
    <ul class="nav nav-tabs">
      <li class="active"><a href="#">swf文件列表</a></li>
      <li><a href="<c:url value="/readonline/list.html"/>">文件列表</a></li>
        ...
        <tbody>
            ...
            <c:forEach var="file" items="${files}">
                <tr>
                    <td>${file.id }</td>
                    <td>${file.fileName }</td>
                    <td><a href="<c:url value="/readonline/toshow.html?id=${file.id}"/>">查看</a></td>
                </tr>
            </c:forEach>
            <tr>
                <td colspan="3">
