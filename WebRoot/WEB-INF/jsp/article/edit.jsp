...
<div class="container" style="margin: 0;width:100%">
    ...
    <form class="form-horizontal" role="form" action="${ctx}/article" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                <input type="text" class="form-control" id="inputTitle" placeholder="文章标题" name="title" value="${article.title }">
            </div>
            <label for="inputEmail3" class="col-sm-2 control-label">文章作者</label>
            <div class="col-sm-4">
                <input type="text" class="form-control" id="inputAuthor" placeholder="文章作者" name="author" value="${article.author }">
            </div>
        </div>
        <div class="form-group">
            <label for="inputEmail3" class="col-sm-2 control-label">内容</label>
            <div class="col-sm-10">
                <script id="inputContent" placeholder="内容" name="content" type="text/plain">${article.content }</script>
            </div>
        </div>
        <div class="form-group">
